...
class Application(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Список товаров и формирование заказа")
    ...
    def create_widgets(self):
        ...
        self.treeview.heading("manufacturer", text="Производитель")
    ...
    def choose_delivery_method(self, total_price):
        delivery_methods = ["Самовывоз", "Курьерская доставка", "Почта России", "СДЭК"]
